...
$$
\mathrm{CI}=0.4\cdot \min(\text{average\_{saturation}},1) + 0.3\cdot \min\!\left(\dfrac{\text{average\_{queue\_{length}}}}{L\cdot 50},1\right) + 0.3\cdot \min\!\left(\dfrac{\text{average\_{delay}}}{60},1\right)
$$
